...
setwd("/Users/kaitlinkarbelk/Desktop/Text Analytics_21/txt files")
nm <- list.files(path="/Users/kaitlinkarbelk/Desktop/Text Analytics_21/txt files")
...
setwd("/Users/kaitlinkarbelk/Desktop/Text Analytics_21/pdf files")
nm <- list.files(path="/Users/kaitlinkarbelk/Desktop/Text Analytics_21/pdf files")
